 ...
 *
 * If https://github.com/kizitonwose/Time/pull/5 is merged. This project can be included as a gradle dependency.
 */
interface TimeUnit {
...
class Interval<out T : TimeUnit>(value: Number, val factory: () -> T) : Serializable {
    ...
    override fun toString(): String = inSeconds.longValue.toString()
}
